...
sudo apt update
sudo apt install -y zsh git curl neofetch
...
git clone https://github.com/marlonrichert/zsh-autocomplete.git $ZSH_CUSTOM/plugins/zsh-autocomplete 2>/dev/null || echo "zsh-autocomplete already exists"
